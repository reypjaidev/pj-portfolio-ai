...
export default function About() {
  return (
    <section
      className="max-w-7xl mx-auto px-[clamp(1rem,4vw,3rem)] py-22"
      id="about"
    >
      ...
      <div className="grid grid-cols-1 lg:grid-cols-[1fr_1.3fr] gap-[clamp(1.5rem,4vw,3.5rem)] items-start">
        ...
        <div className="text-fg text-[1rem] leading-relaxed space-y-4">
          ...
          <p>
            I&apos;m <strong className="text-fg-bright">PJ</strong>, a React JS
            developer with{" "}
            <strong className="text-fg-bright">5 years of experience</strong>{" "}
            building fast, polished and maintainable web apps. I care about
            clean component architecture, smooth UX and shipping things that
            feel as satisfying as a well-executed gank.
          </p>
          <p>
            Off the keyboard I&apos;m a{" "}
            <strong className="text-fg-bright">husband and a dad of two</strong>{" "}
            — my kids, <strong className="text-fg-bright">Luna</strong> and{" "}
            <strong className="text-fg-bright">Shadow</strong>, are the reason
            this whole site is themed after my two favorite heroes. Family is my
            main quest; code is the ranked grind I genuinely love.
          </p>
        </div>
              ...
              >
                {member.img ? (
                  <img
                    ...
                    loading="lazy"
                    className="w-full h-full min-h-[110px] object-cover object-center max-sm:max-h-[300px]"
                  />
                ) : (
                  <div
                    aria-hidden="true"
                    ...
                    style={{
                      background:
                        "radial-gradient(circle at 50% 45%, var(--accent-soft), transparent 70%), linear-gradient(160deg, #1a2030, #10141d)",
